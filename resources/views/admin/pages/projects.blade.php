                            ...
                            <ul class="kebab-dropdown">
                                <li class="has-submenu">
                                    ...
                                    <ul class="kebab-submenu kebab-submenu-left">
                                        <li><button type="button" onclick="openSidebar('details', { title: '{{ addslashes($project->title) }}', category: '{{ addslashes($project->category) }}', type: 'Project', owner: 'me', modified: '{{ $project->updated_at ? $project->updated_at->format('M d, Y') : 'Unknown' }}', created: '{{ $project->created_at ? $project->created_at->format('M d, Y') : 'Unknown' }}', opened: 'Unknown', size: '-', description: '{{ addslashes($project->description) }}', imageUrl: '{{ $project->image_url ? asset($project->image_url) : '' }}', path: 'public/projects/{{ addslashes($project->title) }}' })"><i class="fas fa-list"></i> Details</button></li>
                                        <li><button type="button" onclick="openSidebar('activity', { title: '{{ addslashes($project->title) }}', category: '{{ addslashes($project->category) }}', type: 'Project', owner: 'me', modified: '{{ $project->updated_at ? $project->updated_at->format('M d, Y') : 'Unknown' }}', created: '{{ $project->created_at ? $project->created_at->format('M d, Y') : 'Unknown' }}', opened: 'Unknown', size: '-', description: '{{ addslashes($project->description) }}', imageUrl: '{{ $project->image_url ? asset($project->image_url) : '' }}', path: 'public/projects/{{ addslashes($project->title) }}' })"><i class="fas fa-history"></i> Activity</button></li>
                                    </ul>
                                </li>
                                <li class="has-submenu">
